                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Link href="/tools/gacha" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-purple-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-purple-400 group-hover:text-purple-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-box-open"></i></div>
                            <div>
                    ...
                    <Link href="/tools/author-stock" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-green-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-green-400 group-hover:text-green-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-chart-line"></i></div>
                            <div>
                    ...
                    <Link href="/tools/bingo" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-teal-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-teal-400 group-hover:text-teal-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-ticket-simple"></i></div>
                            <div>
                    ...
                    <Link href="/tools/jackpot" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-yellow-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-yellow-400 group-hover:text-yellow-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-sack-dollar"></i></div>
                            <div>
                    ...
                    <Link href="/tools/quality-judge" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-cyan-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-cyan-400 group-hover:text-cyan-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-scale-balanced"></i></div>
                            <div>
                    ...
                    <Link href="/tools/deathmatch" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-red-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-red-400 group-hover:text-red-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-skull-crossbones"></i></div>
                            <div>
                    ...
                    <Link href="/tools/bounty" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-orange-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-orange-400 group-hover:text-orange-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-scroll"></i></div>
                            <div>
                    ...
                    <Link href="/tools/radar" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-indigo-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-indigo-400 group-hover:text-indigo-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-crosshairs"></i></div>
                            <div>
                    ...
                    <Link href="/tools/escape" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-orange-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-orange-400 group-hover:text-orange-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-triangle-exclamation"></i></div>
                            <div>
                    ...
                    <Link href="/tools/splice" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-pink-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-pink-400 group-hover:text-pink-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-puzzle-piece"></i></div>
                            <div>
                    ...
                    <Link href="/tools/tag-futures" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-yellow-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-yellow-400 group-hover:text-yellow-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-tags"></i></div>
                            <div>
                    ...
                    <Link href="/tools/site-index" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-teal-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-teal-400 group-hover:text-teal-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-globe"></i></div>
                            <div>
                    ...
                    <Link href="/tools/member-admin" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-blue-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-blue-400 group-hover:text-blue-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-users-gear"></i></div>
                            <div>
                    ...
                    <Link href="/tools/delete-announcement" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-red-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-red-400 group-hover:text-red-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-trash-can"></i></div>
                            <div>
                    ...
                    {/* 新增全站图片画廊 */}
                    <Link href="/tools/gallery" className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-fuchsia-500 hover:bg-gray-800 transition-all group flex flex-col justify-between shadow-lg">
                        <div className="grid grid-cols-[min-content_1fr]">
                            <div className="rounded-xl bg-[#24344f] p-[10px_8px] text-fuchsia-400 group-hover:text-fuchsia-500 mb-4 mr-4 max-h-14 text-3xl"><i className="fa-solid fa-images"></i></div>
                            <div>
                                <h2 className="text-xl font-bold text-white mb-2 group-hover:text-fuchsia-400 transition-colors">全站图片画廊</h2>
                                <p className="text-gray-400 text-sm leading-relaxed">自动扫描并提取全站页面中的图片资源，形成可视化的画廊瀑布流展示。</p>
                            </div>
                        </div>
                    </Link>
                </div>
